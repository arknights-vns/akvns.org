    ...
    return (
        <div className="flex flex-col gap-4">
            <div className="space-y-4 text-center">
                ...
                <FavorText>
                    Các đầu truyện do đội ngũ @terrastation thuộc Arknights VNS
                    dịch, hoặc các bên có hợp tác với Arknights VNS
                </FavorText>
            </div>
            <div className="py-12">
                                ...
                                >
                                    ...
                                    <Badge
                                        className={clsx(
                                            "p-3 font-bold",
                                            comic.category ===
                                                "Arknights_VNS" && "bg-primary",
                                            comic.category === "Partner" &&
                                                "bg-amber-400",
                                            comic.category ===
                                                "Collaboration" && "bg-black",
                                            comic.category ===
                                                "Collaboration" &&
                                                "bg-gray-600",
                                        )}
