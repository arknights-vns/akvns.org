            ...
            <section className="grid grid-cols-1 sm:grid-cols-2 gap-10">
                {testimonyData.map((c) => (
                    ...
                    >
                        <CardHeader className="flex flex-col items-start text-left py-2">
                            <div className="flex gap-4 ">
                                <Image
                                    ...
                                    className="w-16 h-16 rounded-full object-cover border-2 shadow-md flex-shrink-0"
                                    height={60}
                                    priority={false}
                                    quality={85}
                                    src={c.avatar}
                        ...
                        <CardContent>
                            <Paragraph className="text-base text-accent-foreground leading-relaxed text-left">
