...
export default function StaffShowcase() {
    return (
        <section
            className={"flex flex-col place-content-center-safe text-center gap-6 py-24"}
        >
            <div className={"text-5xl font-bold text-primary"}>Nhân sự tại Arknights VNS</div>
            <div className={"text-muted-foreground"}>Toàn bộ nhân sự đang hoạt động tại Arknights VNS</div>
            <Tabs className={"gap-y-8"} defaultValue={"leader"}>
                ...
                {
                    (["Leader", "Translator", "Dreamchasers", "Ph. Frontiers", "Partners"] as const).map((group) => {
