...
- example: [This PR adds my name in `README.md`](https://github.com/expressjs/express/pulls?q=is%3Apr+is%3Aclosed+README)
  - Of all seriousness, **DO NOT** do that.

## Your personal checklist

- [ ] I have read the [Contribution Guidelines](https://github.com/arknights-vns/akvns.org/blob/main/.github/CONTRIBUTING.md).
...
- Steps that verify your PR work as intended.
